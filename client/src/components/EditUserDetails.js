...
const EditUserDetails = ({onClose,user}) => {
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 bh-white-700 bg-opacity-40 flex justify-center items-center z-10'>
        <div className='bh-white p-4 py-6 m-1 rounded w-full max-w-sm'>
